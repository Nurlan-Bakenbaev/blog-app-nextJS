...
const Navbar = () => {
  return (
    <nav className=" flex flex-row justify-between py-5 items-center ">
      <Link className="hidden md:block md:text-sm text-center" href="/">
        MY BLOG
      </Link>
      <div className="flex gap-4 items-center jus w-full border">
        {links.map((link) => (
          <Link
        ...
        <button className="outline md:px-3 p-1 text-xs">
