...
export default function Home() {
  return (
    <div className="flex justify-center items-center flex-col md:flex-row p-3">
      <div className="border flex flex-col justify-center  md:w-[40%] w-full">
      ...
      <Image className="px-auto border animate-bounce-custom absolute inset-0" src={heroImg} alt="Hero Image" />
    </div>
  );
}
