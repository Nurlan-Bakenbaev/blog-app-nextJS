  ...
  return (
    <div className="flex justify-center items-center flex-col md:flex-row p-3">
      <div className="flex flex-col justify-center  md:w-[50%] w-full">
        <h1 className="sm:text-3xl md:text-4xl lg:text-7xl py-2 md:py-4 font-bold ">Exploring <span className="text-green-500"> Ideas</span>, Sharing Knowledge</h1>
      ...
      <button className="outline mt-2 p-2 bg-green-500 font-bold  rounded-md">Read the Blogs </button>
      </div>
