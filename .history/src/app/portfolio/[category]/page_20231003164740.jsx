    ...
    <div  className="flex flex-col gap-12">
      ...
      <div className="flex flex-col md:flex-row  items-center gap-12  ">
        <div className="flex  flex-col items-start w-full md:w-[70%]">
          ...
          <button className="px-4 py-2 mt-5 bg-green-500 rounded-lg hover:bg-blue-400 ">See More</button>
        </div> 
        <div>
      ...
      <div className="flex flex-col md:flex-row-reverse  items-center gap-12  ">
        <div className="flex  flex-col items-start w-full md:w-[70%]">
          ...
          <button className="group-hover:bg-blue-400 px-4 py-2 mt-5 bg-green-500 rounded-lg  ">See More</button>
        </div> 
        <div className="group">
            <Image width={850} height={550} src='https://images.unsplash.com/photo-1605379399642-870262d3d051?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3006&q=80' />
        </div>
