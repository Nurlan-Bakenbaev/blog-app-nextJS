...
const About = () => {
  return (
    <div className=" overflow-hidden flex flex-col">
      ...
      <acticle className="flex flex-col gap-5  px-3 py-5 md:flex-row justify-between">
        <div>
        ...
        <div className="flex flex-col "> 
         ...
         <Link className="text-white px-3 py-1 mt-5 mx-auto rounded-md bg-green-600 hover:bg-green-700" href={'/contact'}>Contact</Link>
        </div>
      </acticle>
    </div>
  );
